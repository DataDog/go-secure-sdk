...
func Test_EmptyAlphabet(t *testing.T) {
	t.Parallel()

	_, err := NewEncoding("")
	require.ErrorContains(t, err, "empty alphabet")
}
...
func Test_AmbiguousAlphabet(t *testing.T) {
	...
	require.ErrorContains(t, err, "ambiguous alphabet")
}
...
func Test_Encode(t *testing.T) {
	...
	for _, cs := range testCases {
		...
		require.Equal(t, cs.enc, enc.Encode(hex(cs.dec)))
	}
}
...
func Test_Decode(t *testing.T) {
	...
	for _, cs := range testCases {
		...
		require.Equal(t, cs.dec, h.EncodeToString(dec))
	}
}
...
func Test_NonDecodable(t *testing.T) {
	...
	require.ErrorContains(t, err, "non base character")
