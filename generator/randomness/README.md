...
### func [Alphabet](generators.go#L71)
...
### func [Alphanumeric](generators.go#L57)
...
### func [Int](global.go#L32)

`func Int() int`

Int returns a non-negative pseudo-random int from the default Source.

### func [Int31](global.go#L29)
...
#### func (*LockedRand) [ExpFloat64](locked_rand.go#L146)
...
#### func (*LockedRand) [Float32](locked_rand.go#L110)

`func (lr *LockedRand) Float32() (n float32)`

Float32 returns, as a float32, a pseudo-random number in [0.0,1.0).

#### func (*LockedRand) [Float64](locked_rand.go#L102)

`func (lr *LockedRand) Float64() (n float64)`

Float64 returns, as a float64, a pseudo-random number in [0.0,1.0).

#### func (*LockedRand) [Int](locked_rand.go#L67)

`func (lr *LockedRand) Int() (n int)`

Int returns a non-negative pseudo-random int.

#### func (*LockedRand) [Int31](locked_rand.go#L59)

`func (lr *LockedRand) Int31() (n int32)`

Int31 returns a non-negative pseudo-random 31-bit integer as an int32.

#### func (*LockedRand) [Int31n](locked_rand.go#L85)
...
#### func (*LockedRand) [Int63](locked_rand.go#L35)

`func (lr *LockedRand) Int63() (n int64)`

Int63 returns a non-negative pseudo-random 63-bit integer as an int64.

#### func (*LockedRand) [Int63n](locked_rand.go#L76)
...
#### func (*LockedRand) [Intn](locked_rand.go#L94)
...
#### func (*LockedRand) [NormFloat64](locked_rand.go#L132)
...
#### func (*LockedRand) [Perm](locked_rand.go#L118)

`func (lr *LockedRand) Perm(n int) (r []int)`

Perm returns, as a slice of n ints, a pseudo-random permutation of the integers [0,n).

#### func (*LockedRand) [Read](locked_rand.go#L165)
...
#### func (*LockedRand) [Seed](locked_rand.go#L28)
...
#### func (*LockedRand) [Shuffle](locked_rand.go#L156)
...
#### func (*LockedRand) [Uint32](locked_rand.go#L43)

`func (lr *LockedRand) Uint32() (n uint32)`

Uint32 returns a pseudo-random 32-bit value as a uint32.

#### func (*LockedRand) [Uint64](locked_rand.go#L51)
