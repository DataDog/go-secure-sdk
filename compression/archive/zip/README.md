...
### type [ErrExpansionExplosion](extract.go#L20)
...
#### func (*ErrExpansionExplosion) [Error](extract.go#L27)

`func (e *ErrExpansionExplosion) Error() string`

#### func (*ErrExpansionExplosion) [Is](extract.go#L32)
