...
func TestCreate_DirectoryHierarchyConservation(t *testing.T) {
	t.Parallel()

	// Create a file system with a directory hierarchy
	fileSystem := &fstest.MapFS{
		"under":                      {Mode: fs.ModeDir},
		"under/a":                    {Mode: fs.ModeDir},
		"under/a/directory":          {Mode: fs.ModeDir},
		"under/a/directory/text.txt": {Mode: 0, Data: []byte("deep content")},
	}

	t.Run("no empty directories", func(t *testing.T) {
		t.Parallel()

		// Create a buffer to write the zip archive
		w := &bytes.Buffer{}
		require.NoError(t, Create(fileSystem, w))

		// Open the zip archive
		r, err := zip.NewReader(bytes.NewReader(w.Bytes()), int64(w.Len()))
		require.NoError(t, err)

		// Check the directory hierarchy
		require.Len(t, r.File, 1)
		require.Equal(t, "under/a/directory/text.txt", r.File[0].Name)
	})

	t.Run("with empty directories", func(t *testing.T) {
		t.Parallel()

		// Create a buffer to write the zip archive
		w := &bytes.Buffer{}
		require.NoError(t, Create(fileSystem, w, WithEmptyDirectories(true)))
		...
		require.Equal(t, "under/", r.File[0].Name)
		require.Equal(t, "under/a/", r.File[1].Name)
		require.Equal(t, "under/a/directory/", r.File[2].Name)
		require.Equal(t, "under/a/directory/text.txt", r.File[3].Name)
	})
}
	...
	tests := []struct {
		...
		// ---------------------------------------------------------------------
		{
			...
			wantW: []byte{
				...
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1a, 0x00, 0x00, 0x00, 0x75, 0x6e, //  |..............un|
				0x64, 0x65, 0x72, 0x2f, 0x61, 0x2f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, //  |der/a/directory/|
				0x74, 0x65, 0x73, 0x74, 0x2e, 0x74, 0x78, 0x74, 0x4a, 0x49, 0x4d, 0x2d, 0x50, 0x48, 0xce, 0xcf, //  |test.txtJIM-PH..|
				0x2b, 0x49, 0xcd, 0x2b, 0x01, 0x04, 0x00, 0x00, 0xff, 0xff, 0x50, 0x4b, 0x07, 0x08, 0x02, 0x2a, //  |+I.+......PK...*|
				0xb0, 0x2c, 0x12, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x50, 0x4b, 0x01, 0x02, 0x14, 0x03, //  |.,........PK....|
				0x14, 0x00, 0x08, 0x00, 0x08, 0x00, 0x00, 0x00, 0x21, 0x8a, 0x02, 0x2a, 0xb0, 0x2c, 0x12, 0x00, //  |........!..*.,..|
				0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x1a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //  |................|
				0x01, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x2f, 0x61, 0x2f, //  |........under/a/|
				0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x2e, 0x74, //  |directory/test.t|
				0x78, 0x74, 0x50, 0x4b, 0x05, 0x06, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x48, 0x00, //  |xtPK..........H.|
				0x00, 0x00, 0x5a, 0x00, 0x00, 0x00, 0x00, 0x00, //  |..Z.....|
			},
		},
		{
			...
			wantW: []byte{
				...
				0x21, 0x8a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, //  |!...............|
				0x00, 0x00, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x2f, 0x61, 0x2f, 0x50, 0x4b, 0x03, 0x04, 0x14, 0x00, //  |..under/a/PK....|
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x21, 0x8a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //  |......!.........|
				0x00, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x2f, 0x61, 0x2f, //  |........under/a/|
				0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x50, 0x4b, 0x03, 0x04, 0x14, 0x00, //  |directory/PK....|
				0x08, 0x00, 0x08, 0x00, 0x00, 0x00, 0x21, 0x8a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //  |......!.........|
				0x00, 0x00, 0x00, 0x00, 0x1a, 0x00, 0x00, 0x00, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x2f, 0x61, 0x2f, //  |........under/a/|
				0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x2e, 0x74, //  |directory/test.t|
				...
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x21, 0x8a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //  |......!.........|
				0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, //  |................|
				0x00, 0x40, 0x24, 0x00, 0x00, 0x00, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x2f, 0x61, 0x2f, 0x50, 0x4b, //  |.@$...under/a/PK|
				0x01, 0x02, 0x14, 0x03, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x21, 0x8a, 0x00, 0x00, //  |............!...|
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, //  |................|
				0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x40, 0x4a, 0x00, 0x00, 0x00, 0x75, 0x6e, 0x64, 0x65, //  |.......@J...unde|
				0x72, 0x2f, 0x61, 0x2f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x50, 0x4b, //  |r/a/directory/PK|
				0x01, 0x02, 0x14, 0x03, 0x14, 0x00, 0x08, 0x00, 0x08, 0x00, 0x00, 0x00, 0x21, 0x8a, 0x02, 0x2a, //  |............!..*|
				0xb0, 0x2c, 0x12, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x1a, 0x00, 0x00, 0x00, 0x00, 0x00, //  |.,..............|
				0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x80, 0x7a, 0x00, 0x00, 0x00, 0x75, 0x6e, 0x64, 0x65, //  |........z...unde|
				0x72, 0x2f, 0x61, 0x2f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x74, 0x65, //  |r/a/directory/te|
				0x73, 0x74, 0x2e, 0x74, 0x78, 0x74, 0x50, 0x4b, 0x05, 0x06, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, //  |st.txtPK........|
				0x04, 0x00, 0xf2, 0x00, 0x00, 0x00, 0xd4, 0x00, 0x00, 0x00, 0x00, 0x00, //  |............|
			},
		},
		{
			name: "valid",
